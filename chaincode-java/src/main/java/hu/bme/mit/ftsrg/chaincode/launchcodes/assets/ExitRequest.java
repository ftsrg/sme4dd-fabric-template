...
/// This class represents an exit request for a secure facility.
...
public class ExitRequest implements AssetBase {
  public static final ExitRequest TypeQueryInstance =
      new ExitRequest("TypeQueryInstance", "TypeQueryInstance", null, null, null, null);
